            ...
            try
            {
                ...
                foreach (var i in dictionary)
                {
                    ...
                    PdfCopy pdfCopyProvider = new PdfCopy(sourceDocument,
                        new System.IO.FileStream(currentfilename + " Patient Name- " + i.Key + " Page Name- " + i.Value + " Date- " + DateTime.Now.ToString("dd-MM-yyyy-hh") + ".pdf", System.IO.FileMode.Create));
                    ...
                    for (int e = x; e <= y; e++)
                    {
                        ...
                        string page = Convert.ToString(e);
